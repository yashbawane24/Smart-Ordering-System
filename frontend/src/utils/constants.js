...
export const ORDER_STATUS_CONFIG = {
  ...
  COLLECTED: { label: 'Collected', color: 'bg-[#22C55E]/10 text-[#22C55E] border-[#22C55E]/30', step: 5 },
  COMPLETED: { label: 'Completed', color: 'bg-[#22C55E]/10 text-[#22C55E] border-[#22C55E]/20', step: 5 },
  NO_SHOW: { label: 'No Show', color: 'bg-[#7F1D1D]/40 text-[#F87171] border-[#EF4444]/40', step: 0 },
